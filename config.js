...
module.exports = {
     ...
     */
    botname: process.env.BotName || "ANSH MD BILAL BOT",
    footer: process.env.Footer || "© Powered By ANSH MD BILALZBot",
     ...
     */
    ownername: process.env.Owner_Name || "Ansh Bilal",
    ownernumber: process.env.Owner_Number || "923411489978",
    instagramId: process.env.Insta || "anshchatbotaiz",

    /**
     * other details and parameters
     */
    author: process.env.Author || "@AnshTechie",
    packname: process.env.PackName || "Ansh v2 MD",
    socialLink: process.env.Web || "https://github.com/Ansh-GDS",
    groupLink: process.env.GcLink || "https://chat.whatsapp.com/EnftSCFlaFB1b5BDPdzSBp",
    warns: Number(process.env.Warn_Limits) || 3,
    cooldown: Number(process.env.Cooldown_Timer_Seconds) || 5, // default cooldown time per command in seconds
    mongoUrl: process.env.MongoDB || "https://chat.whatsapp.com/EnftSCFlaFB1b5BDPdzSBpz",
